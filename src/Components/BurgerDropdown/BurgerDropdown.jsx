        ...
        <div className="burger-dropdown-header">
          <div className="contanier">
            <div className="burger-dropdown-header-block">
              ...
              <h3 className="dropdown-head">{burgerHeader}</h3>
            </div>
          </div>
        </div>
          ...
          <div className="contanier">
            <div className="burger-dropdown-nav-list">
              ...
              <ul className="explore-nav-list">
                ...
                <li className="explore-list-item">
                  <Link className="explore-list-item-link">New Arrivals</Link>
                </li>
                <li className="explore-list-item">
                  <Link className="explore-list-item-link">Best Sellers</Link>
                </li>
                <li className="explore-list-item">
                  <Link className="explore-list-item-link">Summer Shop</Link>
                </li>
                <li className="explore-list-item">
                  <Link className="explore-list-item-link">White Shoes</Link>
                </li>
                <li className="explore-list-item">
                  <Link className="explore-list-item-link">
                    Shop All Women's
                ...
                <li className="explore-list-item">
                  <Link className="explore-list-item-link">SALE</Link>
                </li>
              </ul>
            </div>
          </div>
